    ...
    return (
        <Container className="mt-4 w-75">
            ...
            <div className="edit-form">
                <Row>
                    <h2 style={{ fontFamily: "apple-system" }}><strong>House Detail</strong></h2>
                </Row>
                <div className="edit-form ml-4 mt-3 mb-4 mr-4 p-3 border border-primary">
                    <Row>
                        <div class="col-lg-6">
                            <div className="form-group m-1 p-1">
                                <label className="mb-1" htmlFor="title"><strong>Title</strong></label>
                                <p>{currentHouse.title}</p>

                            </div>

                            <div className="form-group m-1 p-1">
                                <label className="mb-1" htmlFor="image"><strong>Image</strong></label>
                                <div>
                                    <img style={{ width: "500px", height: "auto" }} src={currentHouse.selectedFile}></img>
                                </div>
                            </div>


                            <div className="form-group m-1 p-1">
                                <label className="mb-1" htmlFor="description"><strong>Description</strong></label>
                                <p>{currentHouse.description}</p>
                            </div>


                            <div className="form-group m-1 p-1">
                                <label className="mb-1" htmlFor="address"><strong>Address</strong></label>
                                <p>{currentHouse.street},{currentHouse.city},{currentHouse.province}</p>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div className="form-group m-1 p-1">
                                <label className="mb-1" htmlFor="rooms"><strong>Rooms</strong></label>
                                <p>{currentHouse.rooms}</p>
                            </div>

                            <div className="form-group m-1 p-1">
                                <label className="mb-1" htmlFor="people"><strong>Numer of Persons</strong></label>
                                <p>{currentHouse.people}</p>
                            </div>

                            <div className="form-group m-1 p-1">
                                <label className="mb-1" htmlFor="bathrooms"><strong>Bathrooms</strong></label>
                                <p>{currentHouse.bathrooms}</p>
                            </div>

                            <div className="form-group m-1 p-1">
                                <label className="mb-1" htmlFor="price"><strong>Price</strong></label>
